...
## StrainInfo Version 2026.02 Release <date>20 February 2026</date>

This release marks a fundamental shift in our data management strategy.
We are moving toward a **Continuous Update** (Rolling Release) model, supported by a new dynamic archiving system and enhanced strain history processing.

### 1. Rolling Release Infrastructure

To support continuous updates without sacrificing citation stability, we have implemented a two-stage archival system:

* **Placeholder DOIs:** New records are assigned temporary DOI placeholders. These allow for early citation and internal tracking before the final data snapshot is locked.
* **Dynamic to Frozen Archives:** While in the "Rolling" phase, archives remain **malleable**, allowing for real-time corrections and additions. Once a release is finalized, these archives are **frozen**, and the permanent DOI is formally published.

### 2. Automated Strain History Enhancement

Our update pipeline now features an automated enhancement layer. During the ingestion process, the system parses complex history strings to enrich strain exchange history. This results in more complete, interconnected historical records without manual intervention.
...
| --- | --- | --- | --- |
| **Total Strains** | 314,035 | **348,878** | +34,843 |
| **Type Strains** | 20,065 | **33,256** | +13,191 |
| **Deposits** | 476,193 | **521,000** | +44,807 |
...
## StrainInfo Version 2025.08 Release <date>22 August 2025</date>
...
## StrainInfo Version 2025.02 Release <date>25 February 2025</date>
...
## StrainInfo UI version 2024.06 Release <date>13 June 2024</date>
