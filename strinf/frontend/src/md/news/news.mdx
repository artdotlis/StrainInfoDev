...
- **Dynamic to Frozen Archives:** While in the "Rolling" phase, archives remain **mutable**, allowing for real-time corrections and additions. Once a release is finalized, these archives are **frozen**, and the permanent DOI is formally published.
