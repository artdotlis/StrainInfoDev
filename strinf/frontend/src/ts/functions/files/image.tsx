...
const bgI1920 = new URL('@assets/bg/main_1920.avif', import.meta.url).href;
const bgI1280 = new URL('@assets/bg/main_1280.avif', import.meta.url).href;
const bgI800 = new URL('@assets/bg/main_800.avif', import.meta.url).href;
const bgI400 = new URL('@assets/bg/main_400.avif', import.meta.url).href;
...
function createPreloadBanner(): JSX.Element {
    if (UIApiCon.index === window.location.pathname) {
        return (
            <PreLoadH type="image/avif" id="banner_image" href={selectBannerImage()} />
        );
    }
